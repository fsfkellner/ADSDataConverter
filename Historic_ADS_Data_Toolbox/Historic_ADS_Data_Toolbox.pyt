...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [
            ...
            CreateSingleDCAFeatureClassesBeyond2016
            ]
...
class UnionHistoricADSData(object):
    ...
    def getParameterInfo(self):
        ...
        param2.filter.list = range(1962, today.year)
        ...
        param3.filter.list = range(1963, today.year)
...
class CreateSingleDCAFeatureClasses(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Merge single DCA value tables to make feature classes with historic ADS data up to 2016"
        self.description = ""
        self.canRunInBackground = False
    ...
    def getParameterInfo(self):
        ...
        param11.filter.list = range(1962, 2017)
        ...
        param12.filter.list = range(1962, 2017)
    ...
    def updateParameters(self, parameters):
        ...
        if parameters[0].value == "R1":
            parameters[4].filter.list = [
                11000, 11002, 11006, 11007, 11009, 11015, 11029, 11049, 11050,
                11900, 12000, 12003, 12011, 12014, 12015, 12037, 12039, 12040,
                12047, 12049, 12080, 12083, 12096, 12104, 12116, 12117, 12123,
                12128, 12139, 12146, 12159, 12160, 12203, 12900, 14003, 14039,
                14040, 19000, 21000, 21001, 21017, 22057, 23001, 23011, 23023,
                24008, 25000, 25002, 25005, 25022, 25028, 25033, 25034, 25035,
                25039, 25050, 25058, 25062, 25074, 26001, 26002, 26004, 30000,
                30001, 41000, 50002, 50003, 50004, 50005, 50006, 50011, 50012,
                50013, 50014, 50015, 50017, 50800, 70000, 80002, 90000, 90008,
                90009, 90010
                ]
        elif parameters[0].value == "R4":
            parameters[4].filter.list = [
                11001, 11002, 11004, 11005, 11006, 11007, 11009, 11015,
                11019, 11029, 11030, 11037, 11043, 11049, 11050, 11900,
                12000, 12003, 12004, 12005, 12014, 12039, 12040, 12044,
                12047, 12086, 12094, 12096, 12116, 12123, 12171, 12800,
                12900, 14001, 14003, 14029, 14040, 21000, 21014, 22000,
                22026, 22057, 23008, 23011, 24008, 25000, 25001, 25022,
                25028, 25034, 25036, 25039, 25050, 25061, 25900, 26001,
                26032, 26900, 27004, 29005, 30000, 41006, 50003, 50004,
                50005, 50006, 50011, 50013, 50014, 50015, 50016, 70000,
                70008, 80001, 80002, 80005, 90000, 90002, 90008, 90009,
                90010
                ]
    ...
    def execute(self, parameters, messages):
        ...
        featureClasses = NRGG.findAllGeospatialFiles(
            topLevelFolder, 'Damage', fileType="FeatureClass")
...
class CreateSingleDCAFeatureClassesBeyond2016(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Merge single DCA value tables to make feature classes with current ADS data from 2017 and beyond"
        self.description = ""
        self.canRunInBackground = False
    ...
    def getParameterInfo(self):
        ...
        param011.filter.list = range(2017, today.year)

        param012 = arcpy.Parameter(
            displayName='Analysis End Year',
            name='Year which analysis will end',
            datatype='GPstring',
            parameterType="Required",
        ...
        param012.filter.list = range(2017, today.year)

        param013 = arcpy.Parameter(
            displayName='DCA Value',
            name='DCA Value',
            datatype='GPstring',
            multiValue=True,
        ...
        params = [param0010, param010, param011, param012, param013]
        return params
...
class UnionHistoricCurrentADS(object):
    ...
    def getParameterInfo(self):
        ...
        param102.filter.list = range(1962, today.year)
        ...
        param103.filter.list = range(1963, today.year)
