...
class CreateSingleDCAFeatureClasses(object):
    ...
    def getParameterInfo(self):
        ...
        params = [param00, param10, param11, param12, param13]#, param14]
        return params
    ...
    def execute(self, parameters, messages):
        ...
        folderDict = {'R1': r'T:\FS\NFS\R01\Program\3400ForestHealthProtection\GIS\Kellner\R1_Expanded_ADS_Tables',
                      'R4': r'T:\FS\NFS\R01\Program\3400ForestHealthProtection\GIS\Kellner\R4_Expanded_ADS_Tables'}
        
        topLevelADSFolder = folderDict[region]
